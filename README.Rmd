...
The \pkg{stabiliser} package includes a `simulate_data()` function using code adapted from the \pkg{knockoff} package, which allows the user to simulate a dataset as follows:
